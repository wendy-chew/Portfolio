        ...
        <section class="main1" id="language">
            <div class="container main2-grid">
                <div class="left">
                    ...
                    <hr>
                    Western Washington University, USA</h4>
                    <p class="text-muted">Sep 2019 - June 2022</p>
                    <ul>
                        <li>CGPA: 3.82</li>
                    </ul>
                    <hr>
                    <h4>American Degree Transfer Program in Computer Science <br>
                    <hr>

                    Sunway University, Malaysia</h4>
            ...
            <div class="container">
                ...
                <div class="skills-carousel owl-carousel owl-theme">
                    <div class="skill">
                        ...
                        <h3 class="text-white" >Back-end Computing</h3>
                            <p class="text-light" >
                            Able to identify system issues with some back-end concepts include:
                            framework, database management, hardware interaction and security
                        </p>
                    </div>
                    <div class="skill">
                        <p><i class="fas fa-laptop "></i></p>
                        <h3 class="text-white" >Front-end design</h3>
                            <p class="text-light" >
                            Proficient at designing application interfaces for users that are simple, aesthetical and functional
                        </p>
                    </div>
                    <div class="skill">
                        ...
                        <h3 class="text-white" >Leadership & Teamwork</h3>
                            <p class="text-light" >
                                Able to collaborate with team members efficiently using platforms like Git and Github as such platforms make working on codes easy and effective
                            </p>
                    </div>
                    <div class="skill">
                    ...
                    <div class="skill">
                        ...
                        <h3 class="text-white" >Flexibility</h3>
                            <p class="text-light" >
                                Willing to learn complex new software that will increase efficiency and able to adapt to change, particularly regarding how and when work gets done. 
                            </p>
                    </div>
                    <div class="skill">
